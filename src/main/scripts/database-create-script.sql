create table base_entity (id bigint not null auto_increment, primary key (id)) engine=InnoDB;
...
create table notes (id bigint not null auto_increment, recipe_note longtext, recipe_id bigint, primary key (id)) engine=InnoDB;
...
create table unite_of_mesure (id bigint not null auto_increment, uom varchar(255), primary key (id)) engine=InnoDB;
alter table ingredient add constraint FKj0s4ywmqqqw4h5iommigh5yja foreign key (recipe_id) references recipe (id);
alter table ingredient add constraint FKe5rv3ggt0sdt2posj3ar5j8y5 foreign key (uom_id) references unite_of_mesure (id);
